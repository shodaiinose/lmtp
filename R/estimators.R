...
lmtp_tmle <- function(data, trt, outcome, baseline = NULL, time_vary = NULL,
  ...
  estims <- cf_tmle(Task, "tmp_lmtp_scaled_outcome", ratios, learners_outcome, control, pb)
...
lmtp_sdr <- function(data, trt, outcome, baseline = NULL, time_vary = NULL,
  ...
  estims <- cf_sdr(Task, "tmp_lmtp_scaled_outcome", ratios, learners_outcome, control, pb)
